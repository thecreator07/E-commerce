...
function Navbar() {
  ...
  return (
    <section className="flex fixed z-50 bg-white shadow-sm bg-opacity-90 top-0 w-full  justify-between px-1 items-center py-2 md:px-4">
      <h1
        className="font-bold text-3xl hidden md:block text-orange-400 cursor-pointer"
        onClick={() => {
          navigate("/");
          handleSearch();
        }}
      ...
      <div className="flex items-center gap-7 ">
        <label className={`popup ${isAuth?"":"pr-10"}`}>
          <input type="checkbox" />
        ...
        {isAuth && (
          <div className="rounded-full bg-green-200 hover:bg-[#00bf63] p-2 cursor-pointer hover:scale-110  transition-all transit">
            {user?.role === "admin" ? (
              <MdOutlineAddShoppingCart
                onClick={() => {
