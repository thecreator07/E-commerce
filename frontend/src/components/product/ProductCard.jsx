...
const ProductCard = ({ title, description, price, image, id }) => {
  ...
  const handleCart = async () => {
    try {
      ...
      // setSuccess(true); // Optional: Handle success state
    } catch (error) {
      ...
      <div className=" w-[250px] h-[300px] p-2 bg-[#f5f5f5] cardshadow rounded-lg">
        ...
        <div className=" flex justify-between items-center">
          ...
          <div
            ...
            } border-b-amber-950 rounded-full p-1 hover:border-amber-950 cursor-pointer hover:bg-amber-500 transition-all `}
          >
            <svg className="svg-icon w-10 hover:text-white" viewBox="0 0 20 20">
